...
def ticket_buyer(thisWeek, day, movieID) -> bool:
    ...
    if thisWeek:
        fileLocation = "CineStarsProject-pre_release/saved_classes/theater_seats_current_re.json"
    else:
        fileLocation = "CineStarsProject-pre_release/saved_classes/theater_seats_next_re.json"
